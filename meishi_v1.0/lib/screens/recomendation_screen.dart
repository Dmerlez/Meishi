...
class RecomendationView extends StatefulWidget {
  final DocumentSnapshot userInfo;
  static const String routename = "/recomendation_screen";

  const RecomendationView({Key key, this.userInfo}) : super(key: key);

  _RecomendationViewState createState() => _RecomendationViewState();
}

class _RecomendationViewState extends State<RecomendationView> {
                            ...
                            children: <Widget>[
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: <
                                                                        ...
                                                                        Flexible(
                                                                          ...
                                                                          child: Text(
                                                                              _recomendationList[index]['nameUserRecomendation'],
                              ...
                              ButtonTheme(
                                  ...
                                  child: RaisedButton(
                                    ...
                                    child: Text('Escribe una recomendaciòn'),
  ...
  _displayDialog(BuildContext context) async {
    return showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            title: Text('Escribe una recomendación'),
            content: TextField(
              ...
              decoration: InputDecoration(
                  hintText: "Escribir aqui una recomendación...",
  ...
  Future<void> addRecomendation() async {
    ...
    FirebaseFirestore.instance.collection('recomendations').document().setData({
      ...
      'nameUserRecomendation': data.documents.first['name'],
      'cargo': data.documents.first['cargo'],
      'foto': data.documents.first['foto'],
      'fecha': formatted,
    });
